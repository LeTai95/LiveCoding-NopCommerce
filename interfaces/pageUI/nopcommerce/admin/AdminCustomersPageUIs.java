...
public class AdminCustomersPageUIs {
	...
	public static final String PARENT_DROPDOWN_CUSTOMER_ROLES_DROPDOWN = "xpath=//div[@class='k-multiselect-wrap k-floatwrap']";
	public static final String CHILD_DROPDOWN_CUSTOMER_ROLES_DROPDOWN  = "xpath=//ul[@id='SelectedCustomerRoleIds_listbox']//li";
	public static final String DYNAMIC_DROPDOWN_BY_DROPDOWN_NAME = "xpath=//select[@id='%s']";
	public static final String DYNAMIC_EDIT_BUTTON_BY_EMAIL_VALUE = "xpath=//tbody//td[text()='%s']/following-sibling::td[@class='  button-column']/a";
